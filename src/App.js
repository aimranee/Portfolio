    ...
    <section className="section">
      <Card title="Mohamed LACHGAR">
        <p className="m-0">
          ...
          Nationale des Sciences Appliquées de l'Université ChouaibDoukkali, El
          ...
          machine learning et du deep learning dans plusieurs domaines.
        </p>
        <p className="m-0">
          En tant que concepteur et formateur spécialisé dans les technologies
          JAVA, il met en avant les outils et solutions Open Source pour le
          développement de projets Internet et mobile. Il dispense des cours sur
          la plate-forme Java Enterprise Edition (JEE), la programmation mobile,
          la programmation web, la programmation multiplateforme, l'architecture
